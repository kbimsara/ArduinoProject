...
def send_command(command):
    host = '192.168.245.169'  # Replace with the IP address of your ESP8266
    port = 80
...
# ser = serial.Serial('COM6', 115200) # Change the COM port to the one you are using
prev_upCount = -1
totalFingers = 0
...
while True:
    ...
    if totalFingers != prev_upCount:
        ...
        send_command(str(totalFingers))  # Turn LED on
